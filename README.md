...
<h3 align="center">
DevOps & MLOps Engineer | Cloud | Kubernetes | ML Platforms
</h3>

<p align="center">
Building scalable infrastructure, automated delivery pipelines, and production-ready machine learning systems.
</p>
...
I'm a **DevOps & MLOps Engineer** focused on building and operating scalable infrastructure, Kubernetes platforms, CI/CD pipelines, and production machine learning systems.
...
I enjoy building systems across the complete lifecycle:

**Code → Build → Test → Deploy → Train → Validate → Serve → Monitor → Improve**
...
**AWS • Terraform • Kubernetes • Docker • Jenkins • GitHub Actions • Argo CD • KEDA • GitOps • CI/CD • Infrastructure as Code • Infrastructure Automation • Linux • Monitoring • Observability**
...
<a href="https://feast.dev/" target="_blank" rel="noreferrer">
...
<a href="https://kserve.github.io/website/" target="_blank" rel="noreferrer">
...
**DVC • Feast • MLflow • Kubeflow • KServe • ML Pipelines • Feature Stores • Experiment Tracking • Model Registry • Model Training • Model Validation • Model Deployment • Model Serving • Model Monitoring**
...
<p align="center">
<b>⚙️ Automate • ☁️ Scale • ☸️ Orchestrate • 🤖 Train • 🚀 Deploy • 📊 Monitor • 🔄 Improve</b>
</p>
